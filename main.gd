...
func _on_Player_location_update(position):  # position is connected from signal in player.gd and called from main.gd
	follower.update_target_position(position)
